 ...
 * @author Exksn
 */
public class COMWOR extends javax.swing.JFrame {

    /**
     * Creates new form COMWOR
     */
    public COMWOR() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Combination without Repetition");
    ...
    private void CalculateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculateActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "n must be lower than 500!", "Error", JOptionPane.ERROR_MESSAGE);
                ...
                COMWORFactorial myobj2 = new COMWORFactorial();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(COMWOR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
class COMWORFactorial {
    ...
    void Conditions(int n, int r) {
        ...
        COMWORComputation myobj = new COMWORComputation();
        myobj.Conditions(N, R, NR);
        
    }
    
}
    
class COMWORComputation {

    void Conditions(BigInteger N, BigInteger R, BigInteger NR) {
        
        DecimalFormat Format  = new DecimalFormat();

        BigInteger Result = BigInteger.TEN;
        Result = N.divide(R.multiply(NR));
