 ...
 * @author Exksn
 */
public class PERWOR extends javax.swing.JFrame {

    /**
     * Creates new form PERWOR
     */
    public PERWOR() {
        initComponents();
    }
    ...
    private void CalculateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculateActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "n must be lower than 500!", "Error", JOptionPane.ERROR_MESSAGE);
                ...
                PERWORFactorial myobj2 = new PERWORFactorial();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PERWOR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
class PERWORFactorial {
        ...
        void Conditions(int n, int r) {
            ...
            PERWORComputation myobj = new PERWORComputation();
            myobj.Conditions(N, R, NR);
        }

    }
    
class PERWORComputation {
