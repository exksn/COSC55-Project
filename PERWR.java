 ...
 * @author Exksn
 */
public class PERWR extends javax.swing.JFrame {

    /**
     * Creates new form PERWR
     */
    public PERWR() {
        initComponents();
    }
    ...
    private void CalculateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculateActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "n must be lower than 500!", "Error", JOptionPane.ERROR_MESSAGE);
                ...
                PERWRDeclaration myobj2 = new PERWRDeclaration();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PERWR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
class PERWRDeclaration {

    void Conditions(int n, int r) {
            
        BigInteger N = BigInteger.valueOf(n);
            
        Computation myobj = new Computation();
        myobj.Conditions(N, r);
    }
...
class Computation {
    ...
    void Conditions(BigInteger N, int r) {
